...
#                                map_location=self.dev)
            ...
            self.save_path = parser['paths']['base_path']+parser['models']['save_model_mt5_hindi']
            self.save_final_path = parser['paths']['base_path']+parser['models']['save_model_mt5_hindi_final']
        else:
...
#             print("Loaded model from previous checkpoint : ", parser['paths']['base_path']+parser['models']['saved_model_mt5_bengali'])
            self.model = AutoModelForSeq2SeqLM.from_pretrained(self.model_name, return_dict=True)
            self.save_path = parser['paths']['base_path']+parser['models']['save_model_mt5_bengali']
            self.save_final_path = parser['paths']['base_path']+parser['models']['save_model_mt5_bengali_final']
