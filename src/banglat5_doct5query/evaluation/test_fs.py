...
class Counterspeech_generate():
    ...
    def __init__(self, path, index):
        ...
        parser.read(path)
        print("Path : ", parser['paths']['base_path'])
...
#                                      encoding='utf-8',lineterminator='\n')
    ...
    def evaluate_test(self):
        ...
        for i in tqdm(list(range(num_batches)), desc="Evaluating testset"):
            ...
            inputbatch=self.tokenizer.batch_encode_plus(inputbatch,padding=True,max_length=300,
                                                        return_tensors='pt')["input_ids"]
            labelbatch=self.tokenizer.batch_encode_plus(labelbatch,padding=True,max_length=300,
                                                        return_tensors="pt")["input_ids"]
